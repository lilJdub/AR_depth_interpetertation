...
public class CloudBackgroundRender {
    ...
    /**
     * Draws the camera image using the currently configured {@link CloudBackgroundRender#quadTexCoords}
     ...
     * CLoudBackgroundRendererquadTexCoords} image texture coordinates.
     */
